...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bg1~4.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">SIPUSKITA <br/><b>DESA PEPEDAN</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; SIPUSDAN | Desa Pepedan - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
