        ...
        <ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <?php if($this->uri->uri_string() == 'data/kategori'){ echo 'active';}?>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php if($this->uri->uri_string() == 'data/kegiatan'){ echo 'active';} ?>">
                        <a href="<?php echo base_url('data/kegiatan');?>" class="cursor">
                            <span class="fa fa-calendar"></span> Kegiatan
                        </a>
                    </li>

                    <li><a href="<?= base_url('pengunjung') ?>"><i class="fa fa-user"></i> Buku Tamu</a></li>
            ...
            <li class="<?php if($this->uri->uri_string() == 'laporan/jumlah_data'){ echo 'active';} ?>">
                <a href="<?= base_url('laporan/jumlah_data') ?>">
                    <span class="fa fa-download"></span> Laporan
                </a>
            </li>
			<?php }?>
			<?php if($this->session->userdata('level') == 'Anggota'){?>
                ...
                <li class="">
                    <a href="<?= base_url('pengunjung') ?>"><i class="fa fa-user"></i> Buku Tamu</a>
                </li>
				<li class="">
